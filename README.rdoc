...
For more info, please see {Vertigo::Client} or {the docs on RubyDoc.info}[http://rubydoc.info/gems/vertigo].
...
Among other things, that command makes sure you have run `git flow init` (which makes managing contributions easier).
